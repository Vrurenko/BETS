...
<div class="container">
    ...
    <div class="col-sm-offset-2">
        <form class="form-inline" role="form" name="addBetForm" method="POST" action="Controller">
            ...
            <div class="form-group">
                <input type="number" class="form-control" placeholder="<fmt:message key="client.placeholder.race"/>"
                       name="race" required min="1" autocomplete="off">
            </div>

            <div class="form-group">
                <input type="text" class="form-control" placeholder="<fmt:message key="client.placeholder.rider"/>"
                       name="rider" required pattern="[0-9]{2}" autocomplete="off">
            </div>

            <div class="form-group">
                <input type="text" class="form-control" placeholder="<fmt:message key="client.placeholder.amount"/>"
                       name="amount" required pattern="\d+(\.\d{0-2})?" autocomplete="off">
            </div>
    ...
    <div class="jumbotron container" style="padding-top: 0;">
        <div class="panel panel-default">
            ...
            <div class="col-md-6">
                <div class="panel-heading"><p class="text-center"><fmt:message key="client.table.availableraces"/></p>
                </div>
                <table class="table table-hover">
                    <th>ID</th>
