    ...
    <div class="container">
        ...
        <form name="addUserForm" method="POST" action="Controller" class="form-horizontal" role="form">
            ...
            <div class="form-group">
                <label for="login" class="col-sm-4 control-label"><fmt:message key="registration.username"/></label>
                <div class="col-sm-3">
            ...
            <div class="form-group">
                <label for="password" class="col-sm-4 control-label"><fmt:message key="registration.password"/></label>
                <div class="col-sm-3">
            ...
            <div class="form-group">
                <label for="usertype" class="col-sm-4 control-label"><fmt:message key="registration.usertype"/></label>
                <div class="col-sm-3">
            ...
            <div class="form-group">
                <div class="col-sm-7">
                    <input type ="submit" value="<fmt:message key="registration.register"/>" class="btn btn-primary pull-right">
                </div>
            </div>
        </form>
