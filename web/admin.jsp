            ...
            <div class="tab-content">
                <div id="menu1" class="tab-pane fade in active">
                    ...
                    <form name="setWinnerForm" method="POST" action="Controller" class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="number" name="race" id="race" required min="1" autocomplete="off"
                                       class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="winner" id="winner" required pattern="[0-9]{2}"
                                       class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                <button type="submit" class="btn btn-success pull-right"><fmt:message
                                        key="admin.announce"/></button>
                            </div>
                        </div>
                    </form>
                </div>
                <div id="menu2" class="tab-pane fade">
                    ...
                    <form name="addRaceForm" method="POST" action="Controller" class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-3" for="bookmaker"><fmt:message
                                    key="admin.bookmaker"/></label>
                            <div class="col-sm-9">
                                <input type="text" name="bookmaker" id="bookmaker" required autocomplete="off"
                                       class="form-control">
                            </div>
                        </div>
